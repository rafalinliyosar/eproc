...
class AdminAppr extends Component {
    constructor(props) {
        super(props);
        // console.log(props)
        this.state = {
                                ...
                                <table border="1" width="527" height="86">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="167"><font ><b>Admin approved</b></font></td>
                                        ...
                                        {this.state.records.map((record, key) => {
                                            return (
                                                <tr key={key} >
                                                    ...
                                                    <td>{(record.r_appr_not ==='Y' || record.v_appr_not ==='Y')?'Yes':'No'}</td>
...
export default connect(mapStateToProps)(AdminAppr);
