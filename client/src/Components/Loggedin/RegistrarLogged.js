            ...
            <div>
                ...
                <Table cellSpacing="0" cellPadding="0" width="100%" border="0">
                    <tbody>
                        ...
                        <tr>
                            <td height="29"><Link to="/PrDisplay"  >PR forms</Link></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td height="29"><Link to="/ViewEmail"  >View Email address </Link>of Indentor to whom email is to be sent ;<font color="#FF0000">that Registrar's approval is Given</font></td>
                        </tr>
                    </tbody>
                </Table>
                </td></tr>
